...
def initialize_arguments():
    arg_dict = {
        # global arguments
        'test_snapshot_path':           './snapshots/20180426_video_pose_estimation_v1/video_v1_iters_30000.pth.tar',
        'batch_size_test':              1,
        'experiment_name':              '20180427_video_pose_estimation_v1',
        'model_name':                   'video_v1',
        # 'model_name':                   'mb2_dualch',
        'project_root':                 '/root/zyh3/poseestimation/pose_siyuan',
        'gpuid':                        '0,1',
        # arguments for dataset
        'test_image_txt_path':          '/root/group-competition/poseEstimation/data/PoseTrack/posetrack_data/annotations/train_new.txt',
